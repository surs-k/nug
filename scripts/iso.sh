...
run "write boot menu" bash "$SCRIPTS/limine-header-fix.sh" --root /mnt

bash "$SCRIPTS/limine-header-fix.sh" --root /mnt --check || true
...
check "menu starts alone" bash "$SCRIPTS/limine-header-fix.sh" --root /mnt --check
